...
loadComponent("User-info_S", "User-info_S.html");  //사이드 바 내용변경으로 사용 (파일이름변경)
loadComponent("User-info", "User-info.html"); // 내용변경 (파일이름변경)
...
document.getElementById('User-info_S').addEventListener('click', function(e){
