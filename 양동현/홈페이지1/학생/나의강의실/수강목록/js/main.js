document.addEventListener("DOMContentLoaded", function () {
    ...
    const courses = [
        ...
        },
        {
            ...
            lastAccess: "2025-02-20"
        },
        {
            id: 4,
            title: "Spring Boot 웹개발",
            teacher: "변학도",
            period: "2025-02-10 ~ 2025-04-10",
            score: 60,
            progress: 10,
            status: "progress",
        ...
        },
        {
            ...
            lastAccess: "2025-03-10"
        },
        {
            id: 7,
            title: "데이터베이스 기초",
            teacher: "성춘향",
            period: "2025-03-05 ~ 2025-05-05",
            score: 50,
            progress: 0,
            status: "progress",
            purchaseDate: "2025-03-05",
            lastAccess: "2025-03-06"
        },
        {
            id: 8,
            title: "AI 머신러닝",
        ...
        },
        {
            ...
            title: "C언어 프로그래밍",
            teacher: "홍길동",
            period: "2025-03-15 ~ 2025-05-15",
            score: 66,
            progress: 70,
            status: "progress",
            purchaseDate: "2025-03-15",
            lastAccess: "2025-03-20"
        },
        {
            id: 10,
            title: "Kotlin 안드로이드",
            teacher: "이몽룡",
            period: "2025-03-20 ~ 2025-05-20",
            score: 88,
            progress: 20,
            status: "progress",
            purchaseDate: "2025-03-20",
            lastAccess: "2025-03-25"
        },
    ];
        ...
        pageCourses.forEach(c => {
            ...
            card.innerHTML = `
              ...
              <div class="actions">
                ...
                <button>시험보기</button>
                <button>강의후기 작성</button>
                <button>강사후기 작성</button>
              </div>
            `;
