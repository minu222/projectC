...
public class StudentClassController {
    ...
    public StudentClassController(UserService userService) {
    ...
    public String classlist(){
        ...
        return "mainpages/student/myclass/classlist/main";
    }
    ...
    public String classpayments(){
        ...
        return "adminpages/student/myclass/payments/main";
    }

    @GetMapping("/email")
    public String email(){

        return "adminpages/student/myclass/email/main";
    }

    @GetMapping("/noticeboard")
    public String noticeboard(){

        return "adminpages/student/myclass/noticeboard/main";
    }
